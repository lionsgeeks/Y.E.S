...
const HeroArticles = () => {
    ...
    return (
        <div
            className={`w-full h-[60vh] bg-muted-background relative z-10 text-white lg:px-16 flex flex-col justify-center gap-3 bg-no-repeat bg-cover bg-[url('/assets/images/africa5.jpg')] bg-[position:center_top_6%]`}
        >
