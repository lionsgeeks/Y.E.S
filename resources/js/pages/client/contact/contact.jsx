      ...
      >
        ...
        >
          ...
          <p className="text-lg w-[90%]">
            <TransText
              en="Do you have any questions? Need more information? Fill out our contact form available in multiple languages, or connect with us via social media. You can also call or email us, and we will get back to you as soon as possible."
              ...
              fr="Avez-vous des questions ? Besoin de plus d'informations ? Remplissez notre formulaire de contact disponible en plusieurs langues ou connectez-vous avec nous via les réseaux sociaux. Vous pouvez également nous appeler ou nous envoyer un e-mail, et nous vous répondrons dès que possible."
            />
          </p>
        ...
        <form onSubmit={submit} className={`lg:w-[50%] flex flex-col gap-3`}>
          ...
          <button
            type="submit"
            disabled={processing}
            className="bg-black text-white py-3 rounded-lg mt-2 flex items-center justify-center"
          >
            {processing ? (
              <svg
                aria-hidden="true"
