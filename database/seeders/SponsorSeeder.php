    ...
    public function run(): void
    {
        $records = [
            [
                ...
                'website_url' => null,
                'path' => 'assets/images/sponsors/lionsgeek.png',
                'description' => [
            ...
            [
                ...
                'type' => 'technical_partner',
                'website_url' => null,
                'path' => "assets/images/sponsors/RMed_Logo_IECD.png",
                'description' => [
            ...
            [
                ...
                'type' => 'technical_partner',
                'website_url' => null,
                'path' => "assets/images/sponsors/kamlin.jpeg",
                'description' => [
            ...
            [
                ...
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/Africa_50.jpg',
            ],
            [
                'name' => 'UCGC',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/ucgc.jpg',
            ],
            [
                'name' => 'EPIC Africa',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/epic-afric.jpg',
            ],
            [
                'name' => 'PAN',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/pan.jpeg',
            ],
            [
                'name' => 'OUNUSIDA',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/1.jpeg',
            ],
            [
                'name' => 'OIT',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/2.jpeg',
            ],
            [
                'name' => 'UNFPA',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/3.jpeg',
            ],
            [
                'name' => 'CNUCED',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/4.jpeg',
            ],
            [
                'name' => 'IOM',
                'type' => 'sponsor',
                'website_url' => null,
                'path' => 'assets/images/sponsors/5.jpeg',
            ],
            [
                'name' => 'IECD',
                'type' => 'technical_partner',
                'website_url' => null,
                'path' => 'assets/images/sponsors/Méditerranée.jpg',
            ],
            [
                'name' => 'JADARA',
                'type' => 'organizer',
                'website_url' => null,
                'path' => 'assets/images/sponsors/Jadaralogo.png',
                'description' => [
